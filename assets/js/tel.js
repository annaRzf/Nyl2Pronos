    ...
    n(i).on("load", function() {
        ...
        _generateMarkup: function() {
            ...
            this.selectedFlagInner = n("<div>", {
                ...
                class: "arrow"
            }).appendTo(this.selectedFlagInner), this.countryList = n("<ul>", {
                class: "country-list v-hide"
            }).appendTo(t), this.preferredCountries.length && (this._appendListItems(this.preferredCountries, ""), n("<li>", {
                class: "divider"
        ...
        _getCountryData: function(n, i) {
            for (var t = i ? h : this.countries, a = 0; a < t.length; a++)
